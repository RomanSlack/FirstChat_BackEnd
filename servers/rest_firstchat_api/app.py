...
class MessageRequest(BaseModel):
    ...
    tone: str = Field("friendly", description="Message tone (friendly, witty, flirty, casual, confident, unhinged)")
    creativity: float = Field(0.7, description="Creativity level (0.0 to 1.0)", ge=0.0, le=1.0)
    
    @validator('tone')
    def validate_tone(cls, v):
        valid_tones = ["friendly", "witty", "flirty", "casual", "confident", "unhinged"]
